...
//    
//    func present(on entryPoint: UIViewController, viewController: UIViewController, animated: Bool) {
//        entryPoint.present(viewController, animated: animated, completion: nil)
//    }
//    
...
//    }
//    
//    func push(on entryPoint: UIViewController, viewController: UIViewController, animated: Bool) {
//        entryPoint.present(viewController, animated: animated, completion: nil)
//    }
//    
